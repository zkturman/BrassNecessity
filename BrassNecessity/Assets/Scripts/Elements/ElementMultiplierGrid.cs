...
public static class ElementMultiplierGrid
{
    ...
    {
      {NORMAL_MULTIPLIER, STRONG_MULTIPLIER, NORMAL_MULTIPLIER, NORMAL_MULTIPLIER, WEAK_MULTIPLIER },
      {WEAK_MULTIPLIER, NORMAL_MULTIPLIER, STRONG_MULTIPLIER, NORMAL_MULTIPLIER, STRONG_MULTIPLIER },
      {NORMAL_MULTIPLIER, WEAK_MULTIPLIER, NORMAL_MULTIPLIER, STRONG_MULTIPLIER, STRONG_MULTIPLIER },
      {NORMAL_MULTIPLIER, STRONG_MULTIPLIER, NORMAL_MULTIPLIER, NORMAL_MULTIPLIER, NORMAL_MULTIPLIER},
      {STRONG_MULTIPLIER, NORMAL_MULTIPLIER, WEAK_MULTIPLIER, STRONG_MULTIPLIER, NORMAL_MULTIPLIER}
    };
